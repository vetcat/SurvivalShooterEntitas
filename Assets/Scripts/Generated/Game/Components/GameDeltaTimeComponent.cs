...
public partial class GameContext {
    ...
    public Ecs.Features.Game.Components.DeltaTimeComponent deltaTime { get { return deltaTimeEntity.deltaTime; } }
    public bool hasDeltaTime { get { return deltaTimeEntity != null; } }

    public GameEntity SetDeltaTime(float newValue) {
        if (hasDeltaTime) {
            throw new Entitas.EntitasException("Could not set DeltaTime!\n" + this + " already has an entity with Ecs.Features.Game.Components.DeltaTimeComponent!",
...
public partial class GameEntity {
    ...
    public Ecs.Features.Game.Components.DeltaTimeComponent deltaTime { get { return (Ecs.Features.Game.Components.DeltaTimeComponent)GetComponent(GameComponentsLookup.DeltaTime); } }
    ...
    public void AddDeltaTime(float newValue) {
        ...
        var component = (Ecs.Features.Game.Components.DeltaTimeComponent)CreateComponent(index, typeof(Ecs.Features.Game.Components.DeltaTimeComponent));
