...
public partial class GameEntity {
    ...
    public void AddPlayerInput(UnityEngine.Vector3 newInputVector, UnityEngine.Vector2 newMousePosition) {
        ...
        component.InputVector = newInputVector;
        component.MousePosition = newMousePosition;
        AddComponent(index, component);
    }

    public void ReplacePlayerInput(UnityEngine.Vector3 newInputVector, UnityEngine.Vector2 newMousePosition) {
        var index = GameComponentsLookup.PlayerInput;
        var component = (Game.Components.PlayerInputComponent)CreateComponent(index, typeof(Game.Components.PlayerInputComponent));
        component.InputVector = newInputVector;
        component.MousePosition = newMousePosition;
